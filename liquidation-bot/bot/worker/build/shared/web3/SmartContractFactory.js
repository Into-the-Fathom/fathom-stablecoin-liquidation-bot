...
const GetPositionsLiquidationBot_json_1 = __importDefault(require("./ABI/GetPositionsLiquidationBot.json"));
...
const BookKeeper_json_1 = __importDefault(require("./ABI/BookKeeper.json"));
const LiquidationEngine_json_1 = __importDefault(require("./ABI/LiquidationEngine.json"));
const FixedSpreadLiquidationStrategy_json_1 = __importDefault(require("./ABI/FixedSpreadLiquidationStrategy.json"));
class SmartContractFactory {
    ...
    ;
    static GetPositionsLiquidationBot(chainId) {
        return {
            abi: GetPositionsLiquidationBot_json_1.default.abi,
    ...
    static BookKeeper(chainId) {
        return {
            abi: BookKeeper_json_1.default.abi,
            address: SmartContractFactory.Addresses(chainId).bookKeeper
        };
    }
    static LiquidationEngine(chainId) {
        return {
            abi: LiquidationEngine_json_1.default.abi,
            address: SmartContractFactory.Addresses(chainId).liquidationEngine
        };
    }
    static SystemDebtEngine(chainId) {
        return {
            abi: [],
    ...
    ;
    static FixedSpreadLiquidationStrategy(chainId) {
        return {
            abi: FixedSpreadLiquidationStrategy_json_1.default.abi,
